...
/** @import { ExpressionSpecification as Expression, LayerSpecification } from 'maplibre-gl' */
 ...
 *
 * @param {Expression} letExpr - Expression to update.
 ...
 * @returns {Expression} The same array as `expression` if `expression` referred to `propertyName`, or `undefined` if `expression` did not refer to `propertyName`.
 */
 ...
 * @param {unknown[]} localizedNameExpression - An expression that produces a localized name.
 * @param {unknown[]} legacyLocalizedNameExpression - An expression that produces a localized name based on legacy properties in OpenMapTiles.
 */
